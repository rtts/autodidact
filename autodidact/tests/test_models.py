...
class PageTest(TestCase):
    def test_content_accepts_unicode(self):
        '''This test stores and retrieves a Page object with unicode characters in the "content" field. It then checks if the str() method returns proper utf-8 in Python 2, or proper unicode in Python 3.'''
...
class CourseTest(TestCase):
    ...
    def test_url_functions(self):
        ...
        course slug as the sole argument. Additionally, the url() function
        should return a proper <a href> hyperlink (for use in the admin)'''
...
class AssignmentTest(TestCase):
    ...
    def test_string_representation(self):
        '''A simple test to verify that the string representation of an assignment
        is equal to "Assignment X"'''

        representation = 'Assignment {}'.format(self.assignment.get_number())
        self.assertEqual(str(self.assignment), representation)

    def test_get_absolute_url(self):
        '''The absolute url of an assignment should be the "assignment" url with the
        course slug, session number, and assignment number as arguments.'''
    ...
    def test_get_number(self):
        '''The assignment number should be relative: i.e. assignment 1 is always the
        first assignment in the queryset session.assignments'''
    ...
    def test_at_least_one_step(self):
        '''Verify that creating an assignment also creates an associated first
        step'''

        self.assertIsInstance(self.assignment.steps.first(), Step)

    def test_step_count(self):
        '''The function nr_of_steps() should return the number of steps.'''
...
class StepTest(TestCase):
    ...
    def test_string_representation(self):
        '''A simple test to verify that the string representation of a step
        is equal to "Step X"'''
    ...
    def test_get_absolute_url(self):
        '''The absolute url of a step should be the "assignment" url with the
        course slug, session number, and assignment number as
        arguments. The GET parameter "step" should include the step
        number.'''
    ...
    def test_get_number(self):
        '''The step number should be relative: i.e. step 1 is always the
        first step in the queryset assignment.steps'''
...
class CompletedStepTest(TestCase):
    ...
    def test_string_representation(self):
        '''A completed step should render as "username has completed Step X"'''
...
class ClassTest(TestCase):
    ...
    def test_string_representation(self):
        '''Classed should display as "Class X of Session Y"'''
    ...
    def test_student_count(self):
        '''The function "nr_of_students()" should return the number of students.'''
...
class PathFunctionsTest(TestCase):
    ...
    def test_session_path(self):
        '''The function session_path() should, given an object and a filename, return the relative url of the object's "session" attribute with the cleaned filename appended. E.g., session/1/filename.pdf'''
    ...
    def test_image_path(self):
        '''The function image_path() should, given an object and a filename, return the relative url of the object's "step.assignment.session" attribute with the string "images" and the cleaned filename appended. E.g., session/1/images/filename.jpg'''
